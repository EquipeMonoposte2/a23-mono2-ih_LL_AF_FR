...
public class ApplicationFXEvent {
    ...
    public ApplicationFXEvent(boolean estConnectionEvent, boolean estCreationCompteEvent, boolean estNouveauCompteEvent, boolean estDeconnectionEvent, Utilisateur utilisateur) {
