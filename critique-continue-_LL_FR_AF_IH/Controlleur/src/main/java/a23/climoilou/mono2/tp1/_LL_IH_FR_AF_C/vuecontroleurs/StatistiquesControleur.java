...
public class StatistiquesControleur {
    ...
    @FXML
    private TreeView<TreeItemI> utilisateurTreeView1;
    ...
    @FXML
    void initialize() {
        this.afficherUtilisateursTreeViewUtilisateur();
     ...
     *
     */
    public void afficherUtilisateursTreeViewUtilisateur() {
